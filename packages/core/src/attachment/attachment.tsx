...
export const MIME = {
    ...
    ICON: {
        ...
        'audio/mpeg': 'paperclip',
        'video/mpeg': 'paperclip',
        ...
        'audio/ogg': 'paperclip',
        'video/ogg': 'paperclip',
        'application/ogg': 'paperclip',
        'audio/opus': 'paperclip',
        'font/otf': 'paperclip',
        'image/png': 'image',
        ...
        'image/svg+xml': 'image',
        'application/x-shockwave-flash': 'paperclip',
        'application/x-tar': 'paperclip',
        'image/tiff': 'image',
        'video/mp2t': 'paperclip',
        'font/ttf': 'paperclip',
        'text/plain': 'paperclip',
        'application/vnd.visio': 'paperclip',
        'audio/wav': 'paperclip',
        'audio/webm': 'paperclip',
        'video/webm': 'paperclip',
        'video/mp4': 'paperclip',
        'image/webp': 'image',
        'font/woff': 'paperclip',
        ...
        'audio/3gpp': 'paperclip',
        'audio/3gpp2': 'paperclip',
