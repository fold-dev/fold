...
const escapeTableCell = (value) => String(value ?? '').replace(/\|/g, '\\|').replace(/\s+/g, ' ').trim()
...
console.log(`Generated LLM documentation for ${components.length} Core component areas and Design tokens.`)
